...
import { EditPut } from '../Store/UpdateSlice';
...
export default function Edit() {
    ...
    const {data: stateData} = useSelector((state)=>{
        console.log("EDIT_DETAILS_STATE...", state?.details)
    ...
    React.useEffect(()=>{
        setValue("title", stateData?.title)
        setValue("description", stateData?.description)
        setValue("endDate", stateData?.endDate)
        setValue("iscompleted", stateData?.iscompleted)
    },[stateData,setValue])



    const { mutate, ispending } = useMutation({
        mutationFn: ({id,reg}) => dispatch(EditPut({id,reg})),
